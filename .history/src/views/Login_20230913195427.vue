...
const validateUsername = () => {
  ...
  // Перевірка, що текст починається і закінчується буквою
  if (/^[A-Za-z][A-Za-z\-._]*[A-Za-z]$/.test(cleanedName)) {
    cleanedName = cleanedName.replace(/[^A-Za-z\-._]+/g, '');
  } else {
    cleanedName = '';
  }

  formData.name = cleanedName;
};
