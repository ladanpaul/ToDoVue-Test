  ...
  <div class="content-wrapper wrapper">
    <UiHeader>
      <div v-if="user" class="header-wrap">
        ...
        <!-- TODO - Add exit button for future -->
      </div>
    </UiHeader>
    <main class="main">
      <div class="main__inner content-width">
        <header class="header">
            ...
            <div class="create">
              ...
              <div v-show="isCreateTodo" class="create-todo">
                <input
                  placeholder="userId"
                  type="text"
                  class="input create-todo__input"
                ...
                />
                <button class="create-todo__button" @click="createNewTodo">
                  Add
                </button>
              </div>
            </div>
          ...
          <div v-if="todoList && todoList.length" class="todos">
          ...
          <div v-else class="empty-result">Empty Result ( no todos )</div>
        </header>
      </div>
    </main>
  </div>
...
const { getUserById, getTodos, filterBy, createTodo } = useMain();
...
const createNewTodo = async () => {
  ...
  if (todo) {
    filteredTodos.value.unshift(todo);
  }
};
